...
import { PortfolioJavascriptBaza } from '../Baza/BazaPage'
...
const PortfolioCardJavascript = () => {
  return (
    <div className="portfolio-cards">
    {PortfolioJavascriptBaza.map((item, index) => (
        <div key={index}>
...
export default PortfolioCardJavascript